 ...
 */
public class BallyhooOtherCategoriesEventDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ballyhoo_other_categories_events_details_activity);
        ButterKnife.bind(this);
        tabLayoutAdapter = new TabLayoutAdapter(getSupportFragmentManager());
        tabLayoutAdapter.addFragment(new OtherCategoriesBasicDetailsEventsFragment(),
                "Details");
